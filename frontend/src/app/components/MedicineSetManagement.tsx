      ...
      <div className="grid grid-cols-1 xl:grid-cols-[30%_70%] gap-3">
          ...
          <div className="max-h-[62vh] overflow-auto">
            <table className="w-full text-left border-collapse">
              <thead className="sticky top-0 bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 z-10">
                <tr>
                  <th className="px-3 py-2 text-xs font-semibold uppercase">{t('table.name')}</th>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 space-y-3">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            >
              <Plus className="w-3.5 h-3.5" />{t('ui.addMedicine')}</button>
...
function MedicineSetItemMedicineInput({
  ...
  return (
    <div className="relative">
      ...
      {item.medicineId ? (
        <span className="absolute -top-2 right-1 text-[10px] px-1.5 py-0.5 rounded bg-green-100 text-green-700 border border-green-200">{t('ui.pharmacy')}</span>
      ) : (
        <span className="absolute -top-2 right-1 text-[10px] px-1.5 py-0.5 rounded bg-amber-100 text-amber-700 border border-amber-200">{t('ui.manual')}</span>
      )}
