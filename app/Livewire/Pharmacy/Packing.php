...
use App\Models\Pharmacy\Packing as PharmacyPacking;
...
class Packing extends Component
{
    ...
    public $id, $name, $description, $created_by, $updated_by, $deleted_by, $is_active, $is_delete;
    ...
    public function render()
    {
        ...
        $packings = PharmacyPacking::with('user')
        ...
        return view('livewire.pharmacy.packing', ['packings' => $packings]);
    }
    ...
    public function update()
    {
        ...
        $data = PharmacyPacking::findOrFail($this->id);
    ...
    {
        $data = PharmacyPacking::findOrFail($id);
        $this->id = $data->id;
        $this->name = $data->name;
