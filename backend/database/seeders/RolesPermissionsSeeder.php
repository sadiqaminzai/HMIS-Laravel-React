...
class RolesPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'manage_expense_categories', 'display_name' => 'Manage Expense Categories', 'category' => 'Accounts'],
            ['name' => 'view_expense_categories', 'display_name' => 'View Expense Categories', 'category' => 'Accounts'],
            ['name' => 'manage_expenses', 'display_name' => 'Manage Expenses', 'category' => 'Accounts'],
            ['name' => 'view_expenses', 'display_name' => 'View Expenses', 'category' => 'Accounts'],
            ['name' => 'manage_other_income_categories', 'display_name' => 'Manage Other Income Categories', 'category' => 'Accounts'],
            ['name' => 'view_other_income_categories', 'display_name' => 'View Other Income Categories', 'category' => 'Accounts'],
            ['name' => 'manage_other_incomes', 'display_name' => 'Manage Other Incomes', 'category' => 'Accounts'],
            ['name' => 'view_other_incomes', 'display_name' => 'View Other Incomes', 'category' => 'Accounts'],
            // One right per report desk and pharmacy tab. The broad view/manage pair was
            // retired by 2026_09_27_000400: it opened every report at once.
            ['name' => 'view_reports_general', 'display_name' => 'Reports: General', 'category' => 'Reports'],
            ['name' => 'view_reports_reception', 'display_name' => 'Reports: Reception', 'category' => 'Reports'],
            ['name' => 'view_reports_laboratory', 'display_name' => 'Reports: Laboratory', 'category' => 'Reports'],
            ['name' => 'view_reports_surgery', 'display_name' => 'Reports: Surgery', 'category' => 'Reports'],
            ['name' => 'view_reports_room_booking', 'display_name' => 'Reports: Room Booking', 'category' => 'Reports'],
            ['name' => 'view_reports_xray', 'display_name' => 'Reports: X-Ray', 'category' => 'Reports'],
            ['name' => 'view_reports_ultrasound', 'display_name' => 'Reports: Ultrasound', 'category' => 'Reports'],
            ['name' => 'view_reports_ecg', 'display_name' => 'Reports: ECG', 'category' => 'Reports'],
            ['name' => 'view_reports_patient_history', 'display_name' => 'Reports: Patient History', 'category' => 'Reports'],
            ['name' => 'view_reports_expenses', 'display_name' => 'Reports: Expenses', 'category' => 'Reports'],
            ['name' => 'view_reports_other_income', 'display_name' => 'Reports: Other Income', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_stock', 'display_name' => 'Reports: Available Stock', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_purchase', 'display_name' => 'Reports: Purchase', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_sales', 'display_name' => 'Reports: Sales', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_expiry', 'display_name' => 'Reports: Short Expiry', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_low_stock', 'display_name' => 'Reports: Low Stock', 'category' => 'Reports'],
            ['name' => 'view_reports_pharmacy_profit', 'display_name' => 'Reports: Profit', 'category' => 'Reports'],
            ...
            // The discount catalog screen was removed, so there is no list to
            // view, export or import. These two still gate the manual discount
            // field on an appointment, surgery, x-ray or dental receipt.
            ['name' => 'add_discounts', 'display_name' => 'Apply Discounts', 'category' => 'Accounts'],
            ['name' => 'edit_discounts', 'display_name' => 'Edit Discounts', 'category' => 'Accounts'],
            ['name' => 'manage_discounts', 'display_name' => 'Manage Discounts', 'category' => 'Accounts'],
    ...
    private function granularPermissions(): array
    {
        ...
        $resources = [
            ...
            ['name' => 'expense_categories', 'label' => 'Expense Categories', 'category' => 'Accounts'],
            ['name' => 'expenses', 'label' => 'Expenses', 'category' => 'Accounts'],
            ['name' => 'other_income_categories', 'label' => 'Other Income Categories', 'category' => 'Accounts'],
            ['name' => 'other_incomes', 'label' => 'Other Incomes', 'category' => 'Accounts'],
            ['name' => 'ledger', 'label' => 'Ledger', 'category' => 'Accounts'],
