    ...
    public function run(): void
    {
        ...
        $rolePermissions = [
            'admin' => [
                ...
                'view_reports_reception',
                'view_reports_laboratory',
                'view_reports_surgery',
                'view_reports_room_booking',
                'view_reports_xray',
                'view_reports_ultrasound',
                'view_reports_ecg',
                'view_reports_patient_history',
                'view_reports_expenses',
                'view_reports_other_income',
                'view_reports_pharmacy_stock',
                'view_reports_pharmacy_purchase',
                'view_reports_pharmacy_sales',
                'view_reports_pharmacy_expiry',
                'view_reports_pharmacy_low_stock',
                'view_reports_pharmacy_profit',
            ],
            'doctor' => [
                'view_dashboard',
                'view_reception_menu',
