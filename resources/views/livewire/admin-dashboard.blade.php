...
@endphp
<div 
    wire:poll.20000ms.visible="calculateDashboard"
    wire:loading.class="opacity-50"
    wire:target="calculateDashboard"
>
    @if(auth()->user()->hasRole('Administrator'))
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            ...
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                <form wire:submit.prevent="calculateDashboard" class="d-flex align-items-center">
                    <div class="input-group me-2 mb-2 mb-md-0">
                        <input type="date" id="start_date" wire:model="start_date" class="form-control bg-transparent border-primary" placeholder="Start date">
                        <input type="date" id="end_date" wire:model="end_date" class="form-control bg-transparent border-primary" placeholder="End date">
                    </div>
                ...
                <div class="input-group flatpickr wd-200 me-2 mb-2 mb-md-0" id="dashboardDate"></div>
    ...
    @elseif(auth()->user()->hasRole('Pharmacist'))
        ...
        <!-- =======================
             ...
             - No search bar or extra buttons.
             - Shows only today’s Sale Invoice metrics (Total, Paid, Pending)
        ========================== -->
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Pharmacist Dashboard</h4>
            </div>
            <!-- Search bar and extra buttons are intentionally hidden -->
        </div>
        <div class="row py-4">
            <h5 class="mb-3">Sale Invoices (Today)</h5>
            <!-- SALE INVOICE (Total: Paid + Pending) -->
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-0">SALE INVOICE (Total)</h6>
                        <h3 class="mb-0">{{ number_format($todaySaleAmount, 2) }}</h3>
                        <small class="text-muted">Today Total (Paid + Pending)</small>
                    </div>
                </div>
            </div>
            <!-- SALE INVOICE (Paid) -->
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-0">SALE INVOICE (Paid)</h6>
                        <h3 class="mb-0">{{ number_format($todaySaleAmountPaid, 2) }}</h3>
                        <small class="text-muted">Today Paid</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-0">SALE INVOICE (Pending)</h6>
                        <h3 class="mb-0">{{ number_format($todaySaleAmountPending, 2) }}</h3>
                        <small class="text-muted">Today Pending</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    @elseif(auth()->user()->hasRole('Receptionist'))
        <!-- =======================
             ...
             - No search bar or extra sections.
             - Shows only today’s Fees (Total, Paid, Pending) and Service (Total)
        ========================== -->
       <!-- =======================
             RECEPTIONIST DASHBOARD
             - No search bar or extra sections.
             - Shows only today’s Fees (Total, Paid, Pending) and Service metrics (Total, Paid, Pending)
        ========================== -->
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Receptionist Dashboard</h4>
            </div>
        </div>
        <!-- Fees Metrics -->
        <div class="row py-4">
            <h5 class="mb-3">Fees (Today)</h5>
            <!-- FEES (Total) -->
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-0">FEES (Total)</h6>
                        <h3 class="mb-0">{{ number_format($todayFeesAmount, 2) }}</h3>
                        <small class="text-muted">Today Total</small>
                    </div>
                </div>
        ...
        <!-- Service Metrics -->
        <div class="row py-4">
            <h5 class="mb-3">Service (Today)</h5>
            <!-- SERVICE (Total) -->
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-0">SERVICE (Total)</h6>
                        <h3 class="mb-0">{{ number_format($todayServiceAmount, 2) }}</h3>
                        <small class="text-muted">Today Total</small>
                    </div>
                </div>
