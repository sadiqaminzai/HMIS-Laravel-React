...
<head>
    ...
    <title>Stock Quantity Report - Print Version</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="no-print">
            <button onclick="window.print();" style="padding: 5px 10px; background: #4CAF50; color: white; border: none; cursor: pointer; margin-top: 10px;">Print Report</button>
            <button onclick="window.close();" style="padding: 5px 10px; background: #f44336; color: white; border: none; cursor: pointer; margin-top: 10px;">Close</button>
        </div>
    </div>
