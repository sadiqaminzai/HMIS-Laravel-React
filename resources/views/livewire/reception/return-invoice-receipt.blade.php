<div class="container">
    <div class="row mb-1">
        <div class="col-md-12 text-start">
            <h3>Return Invoice Receipt List</h3>
        </div>
    </div>
    <div class="row mb-1">
        <div class="col-md-12 text-start">
    ...
    <div class="row mb-3">
        <div class="col-md-2">
            <select wire:model="search_return_invoice_id" class="form-select">
        ...
        <div class="col-md-2">
            <select wire:model="search_return_invoice_date" class="form-select">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="p-3 rounded border">
                                <strong>Invoice No:</strong>{{ $selectedInvoice?->return_invoice_id }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 rounded border">
                                <strong>Invoice Date:</strong> {{ $selectedInvoice?->return_invoice_date }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 rounded border">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button wire:click="togglePaymentStatus({{ $invoice->id }})"
                            ...
                            <i class="btn-icon-prepend" data-feather="refresh-cw"></i>{{ $invoice->payment_status == 'paid' ? 'Mark as Pending' : 'Mark as Refund' }}
                        </button>
                    @else
                        @if($invoice->payment_status == 'pending')
                            <button wire:click="togglePaymentStatus({{ $invoice->id }})"
                                ...
                                <i class="btn-icon-prepend" data-feather="refresh-cw"></i>Mark as Refund
                            </button>
                        @endif
                    @endif
